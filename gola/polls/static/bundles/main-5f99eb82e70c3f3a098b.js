...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "* {\n    padding:0;\n    margin:0;\n}\n\nhtml{\n    font:14px normal Arial, sans-serif;\n    color:#626771;\n    background-color:#fff;\n}\n\nbody{\n    padding:60px;\n    text-align: center;\n}\n\nul[id=questiontabs]{\n    list-style:none;\n    display: inline-block;\n}\n\nul li[id=questiontab]{\n    display: inline-block;\n    padding: 10px 40px;\n    cursor:pointer;\n    background-color:#eee;\n    color:#7B8585;\n    \n    transition:0.3s;\n}\n\nul li[id=questiontab]:hover{\n    background-color:#beecea;\n}\n\nul li[id=questiontab].focused{\n    color:#fff;\n    background-color:#002266;\n}\n\ninput[id=question] {\n    width: 70%;\n    padding: 12px 20px;\n    margin: 8px 0;\n    border: none;\n    border-bottom: 4px solid #002b80;\n    font-size:20px;\n}\n\ninput[id=question]:focus {\n    outline: none;\n}\n\np{\n    padding-top:15px;\n    font-size:12px;\n}\n\nbutton[id=deleteopt] {\n    background-image: url(" + __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../images/DeleteButton.png\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())) + ");\n    background-size: 20px 20px;\n    border: 0;\n    border-radius: 50%;\n    height: 20px;  \n    width: 20px;\n    margin-left: 100px;\n}\n\nbutton[id=deleteopt]:hover {\n    background-image: url(" + __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../images/DeleteButton_hover.png\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())) + ");\n    background-size: 20px 20px;\n    border: 0;\n    border-radius: 50%;\n    height: 20px;  \n    width: 20px;\n    cursor: pointer;\n}\nbutton[id=deleteopt]:focus {\n    outline: none;\n}\n\nbutton[id=addopt] {\n    background-image: url(" + __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../images/AddButton.png\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())) + ");\n    background-size: 20px 20px;\n    border: 0;\n    border-radius: 50%;\n    height: 20px;  \n    width: 20px;\n    margin-left: 0px;\n}\n\nbutton[id=addopt]:hover {\n    background-image: url(" + __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../images/AddButton_hover.png\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())) + ");\n    background-size: 20px 20px;\n    border: 0;\n    border-radius: 50%;\n    height: 20px;  \n    width: 20px;\n    cursor: pointer;\n}\nbutton[id=addopt]:focus {\n    outline: none;\n}\n\ninput[id=option] {\n    width: 40%;\n    padding: 10px 18px;\n    margin: 8px 0;\n    border: none;\n    border-bottom: 2px solid #006699;\n    font-size:15px;\n}\n\ninput[id=option]:focus {\n    border-bottom: 2px solid #003366;\n    outline: none;\n}\n\nul[id=options]{\n    list-style:none;\n    display: block;\n    align-items: center;\n    list-style-position: inside;\n}\n\nul li[id=option]{\n    display: inline-block;\n    width: 70%;\n    padding: 10px 40px;\n    background-color:#fff;\n    color:#000;\n    font-size: 15px;\n    text-align: left;\n}\n\n", ""]);
